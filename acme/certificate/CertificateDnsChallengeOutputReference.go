...
func (c *jsiiProxy_CertificateDnsChallengeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CertificateDnsChallengeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
