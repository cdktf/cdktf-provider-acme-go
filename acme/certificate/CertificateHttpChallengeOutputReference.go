...
func NewCertificateHttpChallengeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CertificateHttpChallengeOutputReference {
	...
	if err := validateNewCertificateHttpChallengeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CertificateHttpChallengeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CertificateHttpChallengeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
